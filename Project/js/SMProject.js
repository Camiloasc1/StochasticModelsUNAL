...
app.controller('Calculator', ['$scope', function ($scope) {
    ...
    $scope.servers = [{name: "Store 1", proportion: 1.0, serviceRate: 1.0, selected: false, probability: 0.1}];
    $scope.result = 0.0;
    ...
    $scope.addNew = function () {
        ...
        $scope.servers.push({name: name, proportion: 1.0, serviceRate: 1.0, selected: false, probability: 0.1})
    };
